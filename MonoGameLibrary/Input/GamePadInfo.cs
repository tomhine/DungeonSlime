...
public class GamePadInfo
{
    ...
    /// <summary>
    /// Sets the vibration for individual motors of this gamepad.
    /// </summary>
    /// <param name="leftStrength">The strength of the vibration for the left motor from 0.0f (none) to 1.0f (full).</param>
    /// <param name="rightStrength">The strength of the vibration for the right motor from 0.0f (none) to 1.0f (full).</param>
    /// <param name="time">The amount of time the vibration should occur.</param>
